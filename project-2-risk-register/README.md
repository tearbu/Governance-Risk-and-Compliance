# Project 1: Risk Register (ISO 31000/ NIST RMF)

## 🎯 Objective
 Act as a Risk Analyst for a 10-employee cloud startup. Create a risk register, assign risk values and  mitigation measures
